...
//         <button @click="cambiarSeleccion(producto,indiceinterno,'modificarproducto')">m</button>
//         <button @click="cambiarSeleccion(producto,indiceinterno,'eliminarproducto')">e</button>
//     </li>
// </ol>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th class="acciones">Acciones</th></tr>
                </thead>
                <tbody>
                    <tr v-for="(producto,indiceinterno) of productos" :class="{seleccionado: indice==indiceinterno}">
    ...
    methods: {
        cambiarSeleccion(producto, indiceinterno, nuevalengueta) {
            if (nuevalengueta) {
                this.$emit('seleccionado', producto, indiceinterno, nuevalengueta);
            } else {
...
let app = new Vue({
    ...
    methods: {
        ...
        capturarSeleccionado(producto, indice, nuevalengueta) {
            this.producto = producto;
            this.indice = indice;
            if (nuevalengueta) {
                let indice = this.lenguetas.findIndex(lengueta => lengueta.componente == nuevalengueta);
                if (indice > -1)
                    this.lenguetaactual = this.lenguetas[indice];
            }
        },
        anularSeleccionado() {
            this.indice = -1;
