...
Vue.component('clientes-lista', {
    template: /*html*/`
        <div>
            ...
            <clientes-datos v-for="cliente of filtrado" :key="cliente.rut" :datos="cliente"></clientes-datos>
        </div>
    `,
    props: ["lista"],
    data() {
...
Vue.component('clientes-lista2', {
    template: /*html*/`
        <div>
            <input type="search" v-model="filtro">
            <clientes-datos v-for="cliente of lista" :key="cliente.rut" :datos="cliente"
                v-if="cliente.nombre.includes(filtro)"
            ></clientes-datos>
        </div>
    `,
    props: ["lista"],
